...
```{r plot-births-vs-year}
ggplot(data = arbuthnot) +
  geom_line(aes(x = year, y = girls), color="red") +
  geom_line(aes(x = year, y = boys), color="blue") +
  labs(y="number of baptized girls (red) and boys (blue)")
```
